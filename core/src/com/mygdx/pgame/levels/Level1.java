	...
	public void initialize() 
	{
		...
		win=false;
	 	background=new BaseActor(0,0,mainStage);
			...
			TilemapActor tma = new TilemapActor("s.tmx", mainStage);
...
//		}
		...
		//win
		if(BaseActor.count(mainStage, "com.mygdx.pgame.Enemy")<=0&&BaseActor.count(mainStage, "com.mygdx.pgame.SEnemy")<=0)
		{
...
@Override
	public boolean keyDown(int keycode)
	{
		...
		{
			BaseGame.setActiveScreen(new Level2());
		}
