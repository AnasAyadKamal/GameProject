	...
	public void initialize() 
	{
		...
		win=false;
	 	background=new BaseActor(0,0,mainStage);
			...
			TilemapActor tma = new TilemapActor("s3.tmx", mainStage);
	    	...
	    	player=new Player(500,400,mainStage);
	        int i=0;
...
//		}
		...
		if(BaseActor.count(mainStage, "com.mygdx.pgame.Enemy")<=0&&BaseActor.count(mainStage, "com.mygdx.pgame.SEnemy")<=0&&collect)
		{
			...
			if(random==0)
			{
				BulletC n=new BulletC(200,200,mainStage);
			}else if(random==1)
			{
				FireC n=new FireC(200,200,mainStage);
			}else
			{
				ShotgunC n=new ShotgunC(200,200,mainStage);
			}
...
@Override
	public boolean keyDown(int keycode)
	{
		...
		{
			BaseGame.setActiveScreen(new Level4());
		}
